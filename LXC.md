...
dpkg -i commanderdog_0.2.2_amd64.deb
...
wget https://github.com/Woofson/commanderdog/releases/latest/download/commanderdog-v0.2.2-linux-x86_64.tar.gz
tar -xzf commanderdog-v0.2.2-linux-x86_64.tar.gz
cd commanderdog-v0.2.2-linux-x86_64
