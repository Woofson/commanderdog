...
dpkg -i commanderdog_0.1.0_amd64.deb
...
wget https://github.com/Woofson/commanderdog/releases/latest/download/commanderdog-v0.1.0-linux-x86_64.tar.gz
tar -xzf commanderdog-v0.1.0-linux-x86_64.tar.gz
cd commanderdog-v0.1.0-linux-x86_64
